...
- Never commit, push, or rewrite git history (no `commit`, `push`, `rebase`, `reset --hard`, `checkout` over local work, tag/branch deletion) — the owner reviews the working tree.
